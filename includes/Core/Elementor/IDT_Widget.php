...
class IDT_Widget extends Widget_Base
{
    ...
    {
        return _x('Editable Product Add To Cart', 'ELEMENTOR', 'IDT');
    }
    ...
    {
        return ['woocommerce-elements', 'idt-elements'];
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'placeholder' => _x('This will automatically be set for you', 'ELEMENTOR', 'IDT'),
                'default' => [
                    'url' => _x('This will automatically be set for you', 'ELEMENTOR', 'IDT'),
                ],
            ]
        );
    ...
    protected function render()
    {
        ...
        if ('editable' == $product->get_type()) {
            ...
            $this->add_link_attributes('button', [
                'url' => $url,
                'is_external' => '',
                'nofollow' => '',
                'custom_attributes' => ''
            ...
            //If this product is no editable product, this indicates that something is not going right
            //therefore, we just render the usual add to cart template.
            ?>
    ...
    protected function render_text()
    {
        ...
        ?>
        <span <?= $this->get_render_attribute_string('content-wrapper'); ?>>

			<?php if (!empty($settings['icon']) || !empty($settings['selected_icon']['value'])) { ?>

                <span <?= $this->get_render_attribute_string('icon-align'); ?>>
